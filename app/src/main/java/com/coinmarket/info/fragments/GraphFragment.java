...
public class GraphFragment extends Fragment {
    ...
    private SignalFragment.OnFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof SignalFragment.OnFragmentInteractionListener) {
            mListener = (SignalFragment.OnFragmentInteractionListener) context;
        } else {
